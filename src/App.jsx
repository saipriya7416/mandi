    ...
    <div ref={dropdownRef} style={{ position: "relative", width: "100%", display: "flex", flexDirection: "column", gap: "8px" }}>
      ...
      {open && (
        <div style={{
          ...
          <div style={{ marginTop: "12px", borderTop: "1px solid #334155", paddingTop: "12px", display: "flex" }}>
            <button 
              id="party-multiselect-apply"
              onClick={handleApply}
              style={{ 
                width: "100%",
                background: "#3B82F6", 
...
export default function App() {
  ...
  const [supplierClearBtn, setSupplierClearBtn] = useState({ label: "Cancel All", color: "#CC0000" });
  const [buyerSaveBtn, setBuyerSaveBtn] = useState({ label: "Save", color: null });
  const [buyerClearBtn, setBuyerClearBtn] = useState({ label: "Cancel All", color: "#CC0000" });
...
Powered by Stacli mandi os`;
  ...
  const resetPartyManagementState = async () => {
    ...
    // Tab states are preserved to keep user on current page
    await fetchData();
              ...
              {activeUserRoleTab === "Supplier" && (
                <div>
                  ...
                  <div style={{ display: "flex", gap: "16px", marginTop: "32px" }}>
                    ...
                    <Button style={{ background: "#F1F5F9", color: supplierClearBtn.color, border: "none", fontWeight: "900", boxShadow: "0 2px 4px rgba(0,0,0,0.02)" }} onClick={() => handleCancelAll("Supplier")}>{supplierClearBtn.label}</Button>
                  </div>
                </div>
              )}
              ...
              {activeUserRoleTab === "Customer" && (
                <div>
                  ...
                  <div style={{ display: "flex", gap: "16px", marginTop: "32px", flexWrap: "wrap" }}>
                    ...
                    <Button style={{ background: "#F1F5F9", color: buyerClearBtn.color, border: "none", fontWeight: "900", boxShadow: "0 2px 4px rgba(0,0,0,0.02)" }} onClick={() => handleCancelAll("Customer")}>{buyerClearBtn.label}</Button>
                  </div>
                </div>
              )}
                ...
                <div>
                  ...
                  >
                    ...
                    <Button
                      style={{
                        background: "#F1F5F9",
                        color: lotClearBtn.color || "#CC0000",
                        border: "none",
                        fontWeight: "900",
                   ...
                   <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: "20px", padding: "4px" }}>
                    {filteredLots.slice().reverse().map((l, idx) => {
                      ...
                      return (
                        ...
                        >
                          <div style={{ display: "flex", gap: "24px", flexWrap: "wrap", alignItems: "flex-start", marginTop: "10px" }}>
                             <div style={{ display: "flex", flexDirection: "column" }}>
                                <span style={{ fontSize: "9px", color: COLORS.muted, textTransform: "uppercase" }}>Vehicle</span>
                                <span style={{ fontSize: "11px", fontWeight: "800", color: COLORS.sidebar }}>{l.vehicleNumber || "N/A"}</span>
                             </div>
                             <div style={{ display: "flex", flexDirection: "column" }}>
                                <span style={{ fontSize: "9px", color: COLORS.muted, textTransform: "uppercase" }}>Driver</span>
                                <span style={{ fontSize: "11px", fontWeight: "800", color: COLORS.sidebar }}>{l.driverName || "N/A"}</span>
                             </div>
                             <div style={{ display: "flex", flexDirection: "column" }}>
                                <span style={{ fontSize: "9px", color: COLORS.muted, textTransform: "uppercase" }}>Origin</span>
                                <span style={{ fontSize: "11px", fontWeight: "800", color: COLORS.sidebar }}>{l.origin || "N/A"}</span>
                             </div>
                             <div style={{ display: "flex", flexDirection: "column" }}>
                             ...
                             <div style={{ marginLeft: "auto", textAlign: "right", display: "flex", flexDirection: "column" }}>
                                ...
                                <span style={{ fontSize: "9px", fontWeight: "800", color: COLORS.muted, textTransform: "lowercase" }}>kg</span>
                             </div>
                          </div>
                        </PremiumActionCard>
                      );
