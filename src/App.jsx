...
export default function App() {
  ...
  const handleDeleteAllocation = async (id) => {
    if (
      !window.confirm(
        "🗑️ Are you sure you want to PERMANENTLY delete this allocation record?",
      )
    )
      return;
    try {
  ...
  const handleSyncAllocation = async (idx) => {
    ...
    if (!item._id)
      return alert(
        "⚠️ This item is not yet saved to the database. Use 'Record All' instead.",
      );
                ...
                <div style={{ animation: "fadeIn 0.4s ease-out" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        Lot: {lotCreationForm.lotId} | Supplier:{" "}
                        {lotCreationForm.farmerId || "N/A"}
                      </span>
                    </div>
                        ...
                        >
                          ...
                          >
                            ...
                            <div
                              ...
                              onClick={() =>
                                handleLineItemAction("Remove", idx)
                              }
                            >
                              DELETE
                            </div>
                          ...
                          >
                            ...
                            >
                              Net Weight ({item.weightUnit}) Auto
                            </label>
                            <input
                              type="number"
                              disabled
                      ...
                      .map((b) => (
                        ...
                        >
                          <div style={{ flex: 1 }}>
                            ...
                            >
                              {b.billNumber} — {b.supplierId || "Supplier"}
                            </b>
                            <p
                              style={{
                                margin: "4px 0 0",
                          ...
                          <div style={{ display: "flex", gap: "12px" }}>
                            ...
                            <button
                              onClick={async () => {
                                if (
                                  !window.confirm(
                                    "🗑️ Are you sure you want to PERMANENTLY delete this billing record?",
                                  )
                                )
                                  return;
                                const res =
                                  await MandiService.deleteSupplierBill(b._id);
                                if (res.status === "SUCCESS") {
                      ...
                      >
                        ...
                        <tbody>
                          {[
                            ...
                            {
                              module: "≡ƒöù Connection Intelligence",
                              admin: "FULL",
                              accountant: "FULL",
                              ops: "NONE",
                              viewer: "READ",
                            ...
                            {
                              module: "≡ƒÜÜ Transportation Tracking",
                              admin: "FULL",
                              accountant: "READ",
                              ops: "CREATE",
                              viewer: "NONE",
                            ...
                            {
                              module: "⚙️ Product Master & Config",
                              admin: "FULL",
                              accountant: "NONE",
                              ops: "NONE",
                              viewer: "NONE",
                            ...
                            {
                              module: "≡ƒôé Document Management",
                              admin: "FULL",
                              accountant: "READ",
                              ops: "NONE",
                              viewer: "NONE",
